use std::{
    collections::{HashMap, HashSet}, fmt::Debug, io::BufReader, ops::Deref, path::Path
};
...
const PALETTE_PATH: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/palettes/palette_DMC.json");
...
impl PaletteDmc {
    ...
    pub fn load_dmc_palette_from<P: AsRef<Path> + Debug>(path: P) -> Result<PaletteDmc, DmcError> {
